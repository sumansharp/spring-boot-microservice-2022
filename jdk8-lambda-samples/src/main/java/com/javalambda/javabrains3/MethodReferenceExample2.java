...
public class MethodReferenceExample2 {
	...
	public static void main(String[] args) {
		...
		Collections.sort(people, Comparator.comparing(Person::getLastName).reversed());//here Person::getLastName is example of rMethod reference
		//Collections.sort(people, (Person o1, Person o2)->o1.getLastName().compareTo(o2.getLastName())); 
		 
		//people.forEach(System.out::println);
		 //or
		performContionally(people, p->true, System.out::println);//here println is an instance method os System.out 
		 System.out.println("**********************************");
